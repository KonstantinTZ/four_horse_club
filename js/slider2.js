class Slider2 {
    constructor(slider, autoplay = true) {
        // элемент div.single-slide-carousel
        this.slider = slider;
        // все кадры (слайды)
        this.allFrames = slider.querySelectorAll('.single-slide-carousel-item');
        // цепочка кадров
        this.frameChain = slider.querySelector('.single-slide-carousel-slides');
        // кнопка «вперед»
        this.nextButton = slider.querySelector('.single-slide-carousel-next');
        // кнопка «назад»
        this.prevButton = slider.querySelector('.single-slide-carousel-prev');
    ...
    init() {
        ...
        // от ширины контейнера .single-slide-carousel-slides, то есть 900 пикселей
    ...
    dots() {
        ...
        ol.classList.add('single-slide-carousel-indicators');
        const children = [];

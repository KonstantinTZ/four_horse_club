class ParticipantsBigSlider {
    constructor(slider, {autoplay = true, inFrame = 1, offset = 1} = {}) {
        // элемент div.participants-big-carousel
        this.slider = slider;
        ...
        this.allItems = slider.querySelectorAll('.participants-big-carousel-item');
        ...
        this.wrapper = slider.querySelector('.participants-big-carousel-slides');
        // кнопка «вперед»
        this.nextButton = slider.querySelector('.participants-big-carousel-next');
        // кнопка «назад»
        this.prevButton = slider.querySelector('.participants-big-carousel-prev');
    ...
    init() {
        ...
        // ширины контейнера .participants-big-carousel-slides, то есть 100/10 = 10%
    ...
    move() {
        ...
        this.display(this.frameIndex + 1)// меняет число на индикаторе
    ...
    dots() {
        ...
        ol.classList.add('participants-big-carousel-indicators');
        const children = [];
...
export default ParticipantsBigSlider;